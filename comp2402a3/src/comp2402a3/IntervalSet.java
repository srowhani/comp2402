...
/**
 * This interface is for a data structure that stores a set of intervals. These
 * intervals have endpoints of type k and one can query if the set contains any
 * interval that contains a particular value
 *
 * @author morin
 *
 * @param <K>
